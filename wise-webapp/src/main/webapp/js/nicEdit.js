...
var nicEditorConfig = bkClass.extend({
	...
	iconList : {"xhtml":1,"bgcolor":2,"forecolor":3,"bold":4,"center":5,"hr":6,"indent":7,"italic":8,"justify":9,"left":10,"ol":11,"outdent":12,"removeformat":13,"right":14,"save":15,"strikethrough":16,"subscript":17,"superscript":18,"ul":19,"underline":20,"close":21,"arrow":22}
...
var nicEditor = bkClass.extend({
	construct : function(o) {
        ...
        this._blurListener = this.selectCheck.closureListener(this);
        bkLib.addEvent(document.body,'mousedown', this._blurListener );
	},
    ...
    destruct:function(){
        bkLib.removeEvent(document.body,'mousedown', this._blurListener );
    }
