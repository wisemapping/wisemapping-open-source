...
public class UserCouldNotBeAuthException extends ClientException {
    ...
    private static final String MSG_ACCOUNT_SUSPENDED_INACTIVITY = "ACCOUNT_SUSPENDED_INACTIVITY";
    ...
    public static UserCouldNotBeAuthException accountSuspendedInactivity(Throwable cause) {
        return new UserCouldNotBeAuthException(MSG_ACCOUNT_SUSPENDED_INACTIVITY,
                "Account suspended (inactivity): " + cause.getMessage(), cause);
    }
