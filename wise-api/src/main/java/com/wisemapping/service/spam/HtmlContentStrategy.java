...
public class HtmlContentStrategy implements SpamDetectionStrategy {
    ...
    private final static Logger logger = LoggerFactory.getLogger(HtmlContentStrategy.class);
    ...
    private SpamDetectionResult checkHtmlPatterns(String htmlContent) {
        long suspiciousPatterns = SpamContentExtractor.HTML_SPAM_PATTERNS.stream()
                .mapToLong(pattern -> {
