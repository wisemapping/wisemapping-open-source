...
We are continuosly testing the application on the following platforms:
    ...
    * Microsoft Windows
          ...
          ** Safari 3: Due to some SVG bugs in WebKit, the access to the mind map editor is now a days restricted.
    * Linux
          ** Firefox 1.5 and above.
    * OS X
          ** Firefox 1.5 and above: Due to some SVG bugs in Firefox for OS X, you could experience some strange behaviour. Nevertheless, none of them should block you from using the application.
          ** Safari 3: Due to some SVG bugs in WebKit, the access to the mind map editor is now a days restricted.
